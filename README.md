...
[![Chinese](https://img.shields.io/badge/🇨🇳_1459_中文摘要-red)]()
...
| 支柱 | 节点数 | 说明 |
|------|--------|------|
| 🤖 技术能力 | 873 | 新模型、算法、技术突破 |
| 📱 产品模式 | 295 | 交互方式、工作流、AI 应用 |
| 🔧 工具生态 | 250 | 框架、SDK、库、平台 |
| 💰 商业动态 | 247 | 融资、产品发布、市场 |
...
*AI Radar Explorer v3 · Self-evolving Knowledge Graph · Last updated: 2026-06-17 12:03*
