...
[![Chinese](https://img.shields.io/badge/🇨🇳_1402_中文摘要-red)]()
...
| 支柱 | 节点数 | 说明 |
|------|--------|------|
| 🤖 技术能力 | 833 | 新模型、算法、技术突破 |
| 📱 产品模式 | 291 | 交互方式、工作流、AI 应用 |
...
*AI Radar Explorer v3 · Self-evolving Knowledge Graph · Last updated: 2026-06-16 00:03*
