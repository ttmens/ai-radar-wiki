...
sources: ["raw/techcrunch/patreon-stops-asking-ai-bots-not-to-scrape-and-starts-blocking-them.json"]
---

# Patreon stops asking AI bots not to scrape — and starts blocking them

## 中文摘要
Patreon 与 Cloudflare 合作，从被动依赖 robots.txt 转向主动拦截 AI 爬虫，避免创作者内容被未经授权地用于模型训练。此举强调了平台在内容保护上的主动性，利用 Cloudflare 的 bot 管理能力实时阻断违规抓取。对产品经理而言，这代表了内容平台在 AI 生态中保护数据资产的新策略——从协商机制转向技术强制执行，可能影响后续 AI 训练数据的获取成本和合规路径。
